...
int main(void)
{
	...
	{
		xil_printf("find video DMA ID %d\r\n",VGA_VDMA_ID);
	}
	...
	{
		xil_printf("VDMA Configuration Initialization OK %d\r\n",Status);
	}
	...
	{
		xil_printf("Display Ctrl initialization ok during demo initialization%d\r\n",Status);
	}
	...
	{
		xil_printf("start display during demo initialization%d\r\n",Status);
	}
