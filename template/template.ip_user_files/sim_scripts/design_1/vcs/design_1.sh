...
#
# Generated by Vivado on Sun Jan 31 00:42:12 GMT 2021
...
# Design libraries
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_8 processing_system7_vip_v1_0_10 xil_defaultlib xlconcat_v2_1_4 xlconstant_v1_1_7 xlslice_v1_0_2)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "design_1.sh - Script generated by export_simulation (Vivado v2020.2.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_8 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/94c3/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_10 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xlconcat_v2_1_4 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/4b67/hdl/xlconcat_v2_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/fcfc/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../bd/design_1/ip/design_1_xlconstant_0_0/sim/design_1_xlconstant_0_0.v" \
    "$ref_dir/../../../bd/design_1/ip/design_1_led_flasher_0_0/sim/design_1_led_flasher_0_0.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xlslice_v1_0_2 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/d0f7" +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../template.srcs/sources_1/bd/design_1/ipshared/11d0/hdl/xlslice_v1_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/david/Documents/GitHub/djrm-EBAZ4205/template/template.cache/compile_simlib/vcs"
  fi
