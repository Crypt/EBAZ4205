...
proc create_root_design { parentCell } {
  ...
  set ETHERNET_CLOCK [ create_bd_port -dir O -type clk ETHERNET_CLOCK ]
  ...
  # Create instance: led_flasher_0, and set properties
  set block_name led_flasher
  set block_cell_name led_flasher_0
  if { [catch {set led_flasher_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $led_flasher_0 eq "" } {
  ...
  # Create instance: tm1638_demo_0, and set properties
  set block_name tm1638_demo
  set block_cell_name tm1638_demo_0
  if { [catch {set tm1638_demo_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tm1638_demo_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Net [get_bd_ports tm_dio_0] [get_bd_pins tm1638_demo_0/tm_dio]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports ETHERNET_CLOCK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports MULTICOMP_CLOCK] [get_bd_pins led_flasher_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins tm1638_demo_0/clk]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports enet_gmii_txd] [get_bd_pins xlslice_0/Dout]
