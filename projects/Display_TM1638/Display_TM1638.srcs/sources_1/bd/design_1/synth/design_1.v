...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_board_cnt=9,da_clkrst_cnt=6,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ETHERNET_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ETHERNET_CLOCK, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK1, FREQ_HZ 25000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) output ETHERNET_CLOCK;
  ...
  output [7:0]pmod;
  input [0:0]switch;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.TM_CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.TM_CLK_0, CLK_DOMAIN design_1_tm1638_demo_0_0_tm_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) output tm_clk_0;
  output tm_cs_0;
  inout tm_dio_0;
  output tm_rw_0;
  ...
  assign ETHERNET_CLOCK = processing_system7_0_FCLK_CLK0;
  ...
  assign tm_cs_0 = tm1638_demo_0_tm_cs;
  assign tm_rw_0 = tm1638_demo_0_tm_rw;
  ...
  design_1_system_ila_0_0 system_ila_0
       (.clk(processing_system7_0_FCLK_CLK1),
        .probe0(led_flasher_0_led_g),
        .probe1(clk_wiz_0_locked),
        .probe2(switch_1),
