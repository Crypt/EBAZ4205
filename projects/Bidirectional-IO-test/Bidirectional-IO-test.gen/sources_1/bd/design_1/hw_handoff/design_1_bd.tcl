...
proc create_root_design { parentCell } {
  ...
  set sig [ create_bd_port -dir IO sig ]

  # Create instance: bidi_test_0, and set properties
  set block_name bidi_test
  set block_cell_name bidi_test_0
  if { [catch {set bidi_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bidi_test_0 eq "" } {
  ...
  connect_bd_net -net Net [get_bd_ports sig] [get_bd_pins bidi_test_0/sig]
  connect_bd_net -net bidi_test_0_led_g [get_bd_ports led_g] [get_bd_pins bidi_test_0/led_g]
  connect_bd_net -net bidi_test_0_led_r [get_bd_ports led_r] [get_bd_pins bidi_test_0/led_r]
  connect_bd_net -net button_1 [get_bd_ports button] [get_bd_pins bidi_test_0/button]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins bidi_test_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
